...
import type { DecodedSourceMap, EachMapping, EncodedSourceMap, GeneratedMapping, InvalidGeneratedMapping, InvalidOriginalMapping, Needle, OriginalMapping, SourceMap, SourceMapInput, SourceMapV3, SourceNeedle } from '@jridgewell/trace-mapping/dist/types/types';
...
export type { Bias, DecodedSourceMap, DecodedSourceMapXInput, EachMapping, EncodedSourceMap, EncodedSourceMapXInput, GeneratedMapping, InvalidGeneratedMapping, InvalidOriginalMapping, OriginalMapping as Mapping, Needle, OriginalMapping, Section, SectionXInput, SectionedSourceMap, SectionedSourceMapInput, SectionedSourceMapXInput, SourceMap, SourceMapInput, SourceMapV3, SourceNeedle, XInput } from '@jridgewell/trace-mapping/dist/types/types';
